                        ...
                        <li>
                            <router-link :to="menuItem.link">
                                <i
                                    class="bx"
                                    :class="
                                        menuItem.icon || 'bx-square-rounded'
                                    "
                                />
...
export default {
    ...
    props: {
        ...
        bgShadow: {
            type: String,
            default: "0 0 15px 0 rgb(0 0 0 / 5%)",
        },
        bgHoverColor:{
            type: String,
            default: "#f6f6f6",
...
.sidebar .logo-details .logo_name {
    color: rgba(var(--logo-title-color), 1);
    font-size: 20px;
    font-weight: 600;
    opacity: 0;
    transition: all 0.5s ease;
...
.sidebar li a.router-link-active{
    background: linear-gradient(118deg, rgba(var(--active-bg-color), 1), rgba(var(--active-bg-color), 0.7));
}
/* .sidebar li a:hover {
...
.sidebar li a.router-link-active .links_name{
    color: var(--bg-color);
}
